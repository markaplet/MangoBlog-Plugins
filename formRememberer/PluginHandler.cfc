		...
		<cfargument name="event" type="any" required="true" />
			...
			<cfswitch expression="#arguments.event.getName()#">
				...
				<cfcase value="beforeCommentFormEnd">
					...
					<cfoutput><input name="comment_rememberme" id="comment_rememberme" type="checkbox" value="1" /> <label for="comment_rememberme">Remember my information</label></cfoutput>
					</cfsavecontent>
